    ...
    <div className="footer-container">
      <div className="footer">
        <div className="description">
          <img src={require('../../assets/ponti_wine_cellars-logo BLACK.png')} alt=""/>
        ...
        <div className="quick-link">
          ...
          <div className="social-icon">
            <div className="img-wrapper">
              <img src={require('../../assets/facebook-square-brands.svg')} alt="facebook-icon"/>
              <img src={require('../../assets/instagram-brands.svg')}  alt="instagram-icon"/>
            </div>
          </div>
        </div>
      </div>
      <div className="copyright">
        ...
        <ul className="payment">
          <li><img src={require('../../assets/express.png')} alt=""/></li>
          <li><img src={require('../../assets/applepay.png')} alt=""/></li>
          <li><img src={require('../../assets/visa.png')} alt=""/></li>
          <li><img src={require('../../assets/mastercard.png')} alt=""/></li>
          <li><img src={require('../../assets/googlepay.png')} alt=""/></li>
          <li><img src={require('../../assets/paypal.png')} alt=""/></li>
        </ul>
      </div>
    </div>
